 ...
 * @copyright CiviCRM LLC (c) 2004-2010
 * $Id: function.sectionTotal.php 586 2010-10-27 21:56:06Z as $
 */
...
function smarty_function_sectionTotal($params, &$smarty)
{
     ...
     * which is a two-dimensional array keyed to a string which is a pipe-delimited
     * concatenation of ordered permutations of section header values, e.g.,
     * 'foo' => 10,
     * 'foo|bar' => 5,
     * 'foo|bar2' => 5
     */
    ...
    $totalsKey = implode( '|', $sectionValues );
